...
import { IconButton, MyButton } from './Button.styles';

const Button: React.FC<ButtonProps> = ({
	children, arrow, appearance, ...props }): JSX.Element => {
	
	return (
		<MyButton appearance={appearance} {...props} whileHover={{ scale: 1.05 }}>
			{children}
			{arrow && <IconButton arrow={arrow} appearance={appearance} >
