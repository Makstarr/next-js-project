...
import { ButtonIcon, MyButton } from './Button.styles'

const Button: React.FC<ButtonProps> = ({
	children, arrow, appearence, ...props }): JSX.Element => {

	return (
		<MyButton appearence={appearence}{...props}>
			{children}
			{arrow && <ButtonIcon arrow={arrow} appearence={appearence} >
